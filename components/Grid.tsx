  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        {size === "minimized" && (
          <span className="ml-2 text-white text-sm truncate">Overview</span>
        )}
        {size === "normal" && (
      ...
      {/* Content - Only render when not minimized */}
      {size !== "minimized" && (
        <section id="about" className={currentStyle.content}>
          <BentoGrid className="w-full p-10">
